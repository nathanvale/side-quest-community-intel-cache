	...
	x: [
		{
			...
			date: '2026-01-25',
			why_relevant: 'New PBP feature adds picture-by-picture mode control for the monitor',
			score: 28,
		},
	],
	web: [
		{
			...
			why_relevant: 'New DDC workaround enables brightness control on macOS Tahoe',
			score: 35,
		},
	],
}
			...
			x: [
				{
					...
					author_handle: 'test',
					date: null,
					why_relevant: 'This is a detailed explanation that passes the quality filter threshold',
					score: 50,
				},
			],
			web: [],
